...
SampleWorks is a cross-platform sound sample manager inspired by the concept of a [light table](https://en.wikipedia.org/wiki/Light_table). The main objective of the project is to facilitate a very efficient workflow when organizing and processing collections of samples.
